...
select * from RECRUTEMENT_OFF_2024 ;
create table RECRUTEMENT_OFF_2024_2 as select * from RECRUTEMENT_OFF_2024 ;
commit ;

update RECRUTEMENT_OFF_2024 set "id_insnom" = upper("id_insnom");
update RECRUTEMENT_OFF_2024 set "id_insprenom" = upper("id_insprenom");
update RECRUTEMENT_OFF_2024_2 set "id_insnom" = upper("id_insnom");
update RECRUTEMENT_OFF_2024_2 set "id_insprenom" = upper("id_insprenom");

----------------------------------------------------------------------------------------------------------------------

drop table TMP_JARO_WINK_1_RES;
create table TMP_JARO_WINK_1_RES as
select RECRUTEMENT_OFF_2024_2."id_insid" as CIT_ID_IDENTIFIE,
       RECRUTEMENT_OFF_2024_2."id_insid"      ID_51,
       to_number(UTL_MATCH.EDIT_DISTANCE_SIMILARITY(
               PERMUTATION_1(
                       RECRUTEMENT_OFF_2024."id_insnom",
                       RECRUTEMENT_OFF_2024."id_insprenom",
                       RECRUTEMENT_OFF_2024."id_insnom_ar",
                       RECRUTEMENT_OFF_2024."id_insprenom_ar",
                       RECRUTEMENT_OFF_2024."id_insnom_pr",
                       RECRUTEMENT_OFF_2024."id_insnom_mere",
                       RECRUTEMENT_OFF_2024."id_insprenom_mere"
               ),
               PERMUTATION_1(
                       RECRUTEMENT_OFF_2024_2."id_insnom",
                       RECRUTEMENT_OFF_2024_2."id_insprenom",
                       RECRUTEMENT_OFF_2024_2."id_insnom_ar",
                       RECRUTEMENT_OFF_2024_2."id_insprenom_ar",
                       RECRUTEMENT_OFF_2024_2."id_insnom_pr",
                       RECRUTEMENT_OFF_2024_2."id_insnom_mere",
                       RECRUTEMENT_OFF_2024_2."id_insprenom_mere"
               )
                 ))                as RES
from RECRUTEMENT_OFF_2024,
     RECRUTEMENT_OFF_2024_2
where  RECRUTEMENT_OFF_2024."id_insid" <> RECRUTEMENT_OFF_2024_2."id_insid"
...
create table tmp_double_recrutement_off_vd as select * from TMP_JARO_WINK_RES_IDENTIFIE_t ;
