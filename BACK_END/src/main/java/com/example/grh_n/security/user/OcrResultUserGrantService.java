...
//    private final OcrResultService ocrResultService;
    ...
    public OcrResultUserGrantService(OcrResultUserGrantRepository ocrResultUserGrantRepository, UserService userService) {
...
//        }
    ...
    public  void deleteOcrResultGrants(List<OcrResultUserGrant> grants){
        ocrResultUserGrantRepository.deleteAll(grants);
    }
}
