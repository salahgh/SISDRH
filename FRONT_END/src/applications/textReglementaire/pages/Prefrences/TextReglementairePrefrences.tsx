...
import {
    ...
    OcrResultPdfDocument, PrivilegesEnum,
    UnpinOcrResultDocument
} from "../../../../_generated_gql_/graphql";
import {useEffect, useState} from "react";
import {IconButton, LinearProgress, List, ListItemButton, ListItemText, Paper, Stack, Typography} from "@mui/material";
...
const TextReglementairePrefrences = () => {
    ...
    const {
        ...
        loading,
        refetch
    } = useQuery(FindAllPinnedFilesDocument);
        ...
        >
            ...
            <Stack direction={'row'} flex={1} height={'100%'}>
                            ...
                            data?.findPinnedOcrResults?.map((item, index) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <ListItemIcon>
                                            <ConfidentialiteIcon
                                                libConfidentialiteAr={item?.ocrResult?.confidentialite?.libConfidentialiteAr}
                                            />
                                        </ListItemIcon>
                                        <IconButton
                ...
                <Stack direction={'column'} flex={2}>
                    {
                        pdfFileLoading && <LinearProgress sx={{
                            width: '100%'
                        }}></LinearProgress>
                    }
                    {
