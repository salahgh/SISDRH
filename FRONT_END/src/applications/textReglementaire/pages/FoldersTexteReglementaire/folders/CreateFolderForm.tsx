...
const CreateFolderForm = ({setOpen }: { setOpen: any }) => {
   ...
   const validationSchema = yup.object().shape({
      ...
      name: yup
         .string().required("le nom du dossier est obligatoire"),
            ...
            return (
               <form onSubmit={handleSubmit}>
                  <Stack spacing={1} sx={{marginTop: 6, marginBottom: 6}}>
                     <Field label={'nom du dossier'} name={'name'} sx={{marginBottom: 1, flex: 1}}
                            component={TextField}/>
                     <Field label={'description'} name={'description'} sx={{marginBottom: 1, flex: 1}}
                            component={TextField}/>
                     <Field label={'couleur'} name={'color'} sx={{marginBottom: 1, flex: 1}} component={TextField}/>
                  </Stack>
