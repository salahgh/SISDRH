  ...
  return (
    <Stack flex={1}>
      <TabContext value={value}>
        ...
        <TabPanel sx={{ height: "calc(100vh - 165px)", padding: 1 }} value="3">
          <UserRolesAndPrivileges />
        </TabPanel>
        <TabPanel sx={{ height: "calc(100vh - 195px)", padding: 1 }} value="4">
          <RolesAssociatedPrivilegesList />
        </TabPanel>
        <TabPanel sx={{ height: "calc(100vh - 195px)", padding: 1 }} value="5">
          {/*<RolesPrivileges/>*/}
