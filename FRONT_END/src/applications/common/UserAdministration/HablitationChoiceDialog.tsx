...
import {GetHablitationsDocument, SetHabilitationDocument, UserDocument} from "../../../_generated_gql_/graphql";
...
const HablitationChoiceDialog = ({open, setOpen, userName}) => {
    ...
    const [setHabilitation,
        {
            data,
            loading,
            error
        }] = useMutation(SetHabilitationDocument,{
            refetchQueries : [{ query : UserDocument , variables : {matricule: userName} }]
    });
    ...
    return (
        ...
        >
            <DialogContent>
                ...
                >
                    {
                        habilitations?.habilitations?.map(
                            (item, index) => {
                                return (
                                    <Card>
                                        <CardActionArea
