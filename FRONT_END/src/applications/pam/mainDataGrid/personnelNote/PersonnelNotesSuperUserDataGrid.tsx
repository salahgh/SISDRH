...
export const PersonnelNotesSuperUserDataGrid = () => {
  ...
  const {
    ...
    error,
    refetch,
  } = useQuery(FindAllPersonnelNotesPagedDocument, {
    ...
    <Stack spacing={1} padding={1}>
      <Stack direction={"row"} spacing={1}>
        ...
        <ToggleButtonGroup
          exclusive={true}
          onChange={(e, v) =>
            setSearchParams((old) => ({ ...old, ownership: v }))
          }
        ...
        <TextField
          ...
          onChange={(e) =>
            setSearchParams((old) => ({ ...old, searchToken: e.target.value }))
          }
        ></TextField>
      </Stack>
